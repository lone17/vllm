...
from vllm.config import CompilationLevel, ControlVectorConfig, VllmConfig
...
class GPUModelRunnerBase(ModelRunnerBase[TModelInputForGPU]):
    ...
    def load_model(self) -> None:
        ...
        if self.control_vector_config:
            ...
            self.model = (
                self.control_vector_manager.create_control_vector_manager(  # noqa: E501
                    self.model
                )
            )
