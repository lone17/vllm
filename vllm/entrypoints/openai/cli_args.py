    ...
    def __call__(
        ...
        for item in values:
            try:
                ...
                control_vector = LoRAModulePath(**control_vector_dict)
            ...
            control_vector_list.append(ControlVectorPath(**control_vector_dict))
...
def make_arg_parser(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
    ...
    parser.add_argument(
        ...
        help=(
            "Control vector configurations in the format name=path. "
            "Multiple control vectors can be specified."
        ),
    )
    parser.add_argument(
        "--chat-template",
