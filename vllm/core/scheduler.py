...
class SchedulerOutputs:
    ...
    @property
    def control_vector_requests(self) -> Set[ControlVectorRequest]:
        return {
            g.seq_group.control_vector_request
            for g in self.scheduled_seq_groups
            if g.seq_group.control_vector_request is not None
        }
...
class Scheduler:
    ...
    def _preempt(
        self, seq_group: SequenceGroup, blocks_to_swap_out: List[Tuple[int, int]]
    ) -> PreemptionMode:
